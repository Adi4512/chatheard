...
const Button = ({
  ...
  const variantStyles = {
    primary:
      "bg-primary-600 text-white hover:bg-primary-700 shadow-sm focus:ring-primary-600",
    secondary:
      "bg-secondary-600 text-white hover:bg-secondary-700 shadow-sm focus:ring-secondary-600",
    outline:
